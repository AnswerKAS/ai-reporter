...
META = {"id": "7230ff8040f54f339f168a8ce1fe458b", "slug": "reports-py-fields-04fd40", "title": "Отчет по пайрус полям", "description": "Скилл создан агентом по описанию и согласован администратором.", "skill": "reports/py-fields", "params": {}}
